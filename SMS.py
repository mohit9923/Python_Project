...
class form1:
    def add(self):
        if self.tb1.get()=="" or self.tb2.get()=="" :
            ...
            obj=open("e:\\mohit_project\\message_project1.txt","a")
            gpname=self.tb1.get()
...
class form2:
    def __init__(self):
        ...
        self.rd=open("e:\\mohit_project\\message_project1.txt","r")
        self.i=0
        while True:
...
class form3:
    def insert(self):
        if self.textbox2.get()!="" and self.textbox2.get().isnumeric()==True and len(self.textbox2.get())==10:
            ...
            wr=open("e:\\mohit_project\\phones.txt","a")
    ...
    def __init__(self):
        ...
        fileopen=open("e:\\mohit_project\\message_project1.txt","r")
...
class form4:
    ...
    def insert(self):
        ...
        rd=open("e:\\mohit_project\\phones.txt","r")
        i=0
        while True:
            line=rd.readline()
            if line=="":
    ...
    def covertmob(self):
        ...
        for child in self.tree.get_children():
            ...
            conn.request('GET',"/VMMCloudMessaging/AWS_SMS_Sender?username=dhk_py&password=GNEP0QCE&message="+a+"&phone_numbers="+num+"")
...
label1=tkinter.Label(root,text=" PYTHON PROJECT ",bg="mint cream",fg="black",font="HELVETICA 26")
label1.pack()
root.config(bg="bisque")
label2=tkinter.Label(root,text=" By:-JAHNVI,SAMIYA,MOHIT ",bg="mint cream",fg="black",font="HELVETICA 14")
label2.pack()
